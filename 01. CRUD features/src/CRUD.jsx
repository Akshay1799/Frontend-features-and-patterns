...
const CRUD = () => {
    ...
    const filteredTodos = search.trim() === '' ? todos : todos.filter((todo) => todo.toLowerCase().includes(search.toLowerCase()))
    ...
    return (
        <div className='min-h-screen bg-gray-50'>
            ...
            <div className='flex  items-center flex-col mx-auto 0 max-w-6xl my-12 '>
                ...
                {todos.length > 0 && (
                    <div className=' border border-gray-300 rounded-lg px-8 py-6 mt-8'>
                        <div className="flex gap-2 mt-2 justify-center">
                            <input
                                value={search}
                                onChange={(e) => setSearch(e.target.value)}
                                className="min-w-xl px-4 py-2 outline-none border border-gray-300 rounded-lg shadow-sm"
                                type="text"
